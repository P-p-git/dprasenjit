...
const svgIcons = {
  ...
  routine: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><path d="M8 14h.01M12 14h.01M16 14h.01M8 18h.01M12 18h.01"/></svg>,
  ...
  queries: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>,
...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const links = {
    admin: [
      ...
      { to: '/queries', label: 'Queries', icon: 'queries' },
      { section: 'Account' },
    ...
    student: [
      ...
      { to: '/notices', label: 'Notices', icon: 'notices' },
      { to: '/routine', label: 'Routine', icon: 'routine' },
      { to: '/queries', label: 'Query / Issue', icon: 'queries' },
      { section: 'Account' },
      { to: '/profile', label: 'Profile', icon: 'profile' },
      { to: '/settings', label: 'Settings', icon: 'settings' },
    ],
